...
function woocommerce_custom_single_add_to_cart_text() {
    return __( 'Acquista', 'woocommerce' ); // Modifica qui il testo
}
...
// Cambia testo bottone "Procedi con l'ordine" nel carrello
add_filter( 'gettext', function( $translated, $original, $domain ) {
    if ( $domain === 'woocommerce' && $original === 'Proceed to checkout' ) {
        return 'Calcola il totale con eventuali sconti';
    }
    return $translated;
}, 20, 3 );